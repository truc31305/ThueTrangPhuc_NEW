<section class="section policy-page">
	<h1>📜 CHÍNH SÁCH THUÊ ĐỒ TẠI SAPAQT</h1>

	<h2>1. Chính sách đặt thuê</h2>
	<p>Khách hàng có thể đến trực tiếp cửa hàng hoặc đặt thuê online qua website, fanpage, hotline.</p>
	<p>Để giữ trang phục, khách hàng cần đặt cọc trước 30–50% giá thuê.</p>
	...
	<h2>3. Chính sách thời gian thuê</h2>
	<p>Thời gian thuê tiêu chuẩn: 1–3 ngày.</p>
	<p>Nếu khách có nhu cầu thuê lâu hơn, cần báo trước để được thỏa thuận.</p>
	<p>Trả trễ sẽ tính thêm phí theo ngày, tối đa 50% giá thuê/ngày.</p>
	...
	<h2>🤝 CAM KẾT DỊCH VỤ CỦA SAPAQT</h2>
	<ul>
		<li>Trang phục chất lượng – luôn trong tình trạng tốt nhất, được giặt hấp chuyên nghiệp.</li>
		<li>Giá cả minh bạch – không phát sinh chi phí bất ngờ.</li>
		<li>Dịch vụ tận tâm – đội ngũ nhân viên hỗ trợ khách hàng từ khâu chọn đồ đến khi trả đồ.</li>
		<li>Cập nhật liên tục – SAPAQT luôn bổ sung mẫu mới để đáp ứng xu hướng thời trang.</li>
		<li>Uy tín – chuyên nghiệp – đặt lợi ích và trải nghiệm của khách hàng lên hàng đầu.</li>
	</ul>
</section>
